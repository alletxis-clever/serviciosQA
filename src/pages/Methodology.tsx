        ...
        <div className="methodology-container">
          <div className="methodology-content">
            ...
            <div className="methodology-benefits">
              <h2 className="section-title">✨ ¿Por qué TMAP?</h2>
            ...
            <div className="methodology-main-content">
              ...
              <div className="tmap-roadmap">
                ...
                <div className="roadmap-container">
                    ...
                    <div className="roadmap-step">
                      ...
                      <div className="step-details">
                        <ul>
                          ...
                          <li>Definición de objetivos de calidad</li>
                          <li>Alineación con stakeholders</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="roadmap-step">
                      ...
                      <div className="step-details">
                        <ul>
                          ...
                          <li>Creación de plantillas y checklists</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="roadmap-step">
                      ...
                      <div className="step-details">
                        <ul>
                          ...
                          <li>Gestión de pruebas basada en riesgos</li>
                    ...
                    <div className="roadmap-step">
                      ...
                      <div className="step-details">
                        <ul>
                          ...
                          <li>Estandarización corporativa</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="roadmap-line">
                    ...
                    <div className="step-connector step-connector-3"></div>
                    <div className="step-connector step-connector-4"></div>
                    <div className="step-connector step-connector-5"></div>
                  </div>
                </div>
              </div>
            </div>
