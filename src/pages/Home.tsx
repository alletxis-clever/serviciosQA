    ...
    <div className="home">
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">🌟 Propuesta de Servicios QA</h1>
          <p className="hero-description">{COMPANY_INFO.description}</p>
          <p className="hero-approach">{COMPANY_INFO.approach}</p>
        </div>
      </section>
      ...
      <section className="cta">
        ...
        <p className="cta-text">
          Desde pruebas manuales hasta automatización y DevTestOps, tenemos la
